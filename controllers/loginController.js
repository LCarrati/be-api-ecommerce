...
const handleLogin = async (req, res) => {
	...
	if (match) {
		...
		// console.log('refresh token é ' + refreshToken)
		// console.log('res é ' + res)
		// console.log('Before setting cookie:', res.getHeader('set-cookie'));
		res.cookie('jwt', refreshToken, {httpOnly: true, sameSite: 'None', secure: true, maxAge: 24 * 60 * 60 * 1000} ).status(200) //1 dia
